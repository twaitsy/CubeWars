...
public class DiagnosticUI : MonoBehaviour
{
    ...
    void DrawDatabases()
    {
        GUILayout.Label("Databases", GUI.skin.box);
    ...
    {
        GUILayout.Label("Runtime Resource + Production State", GUI.skin.box);
    ...
    {
        GUILayout.Label("Jobs + Workers", GUI.skin.box);
    ...
    {
        GUILayout.Label("Scene Systems Snapshot", GUI.skin.box);
