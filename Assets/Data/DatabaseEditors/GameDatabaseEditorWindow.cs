...
public class GameDatabaseEditorWindow : EditorWindow
{
    ...
    void DrawList()
    {
        ...
        if (GUILayout.Button("Add New", GUILayout.Height(25)))
        {
            ...
            switch (currentTab)
            {
                ...
                case Tab.Tech: targetDB = db.techTree; break;
        ...
        switch (currentTab)
        {
            ...
            case Tab.Resources:
                ...
                break;
            case Tab.Tech:
                DrawVirtualized(db.techTree != null ? db.techTree.techNodes : null, DrawTechButton);
                break;
            case Tab.Tools:
    ...
    private string GetDisplayName(object obj)
    {
        ...
        if (obj is TechNodeDefinition t2) return t2.displayName ?? "";
    ...
    private void DrawTechButton(TechNodeDefinition t, int i)
    {
        if (t == null) return;
    ...
    private SerializedProperty GetActiveList(SerializedObject so)
    {
        switch (currentTab)
        {
            ...
            case Tab.Tech: return so.FindProperty("techNodes");
